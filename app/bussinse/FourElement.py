...
class FourElement(object):
    ...
    def get_verify_code(self, id_number):
        ...
        mapping_code = {'0': '1', '1': '0', '2': 'X', '3': '9', '4': '8', '5': '7', '6': '6', '7': '5', '8': '4',
                        '9': '3', '10': '2'}  # 校验码映射
    ...
    def generate_bank_code(self, bank_name=None):
        ...
        width = bank_code_length - len(bank_code_bin) - 1
        max_string = '9999999999999'
        max_num = int(max_string[0:width])
        random_code = str(random.randint(0, max_num)).zfill(width)
        bank_code = str(bank_code_bin) + random_code
