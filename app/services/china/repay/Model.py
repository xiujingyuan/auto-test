...
class WithholdOrder(db.Model, BaseToDict):
    ...
    withhold_order_withhold_sub_status = db.Column(db.Enum('normal', 'payment_cancel', 'agreement', 'user_cancel', 'offline'), nullable=False, info='子状态,normal:正常,payment_cancel:协议支付取消,agreement:协议支付')
