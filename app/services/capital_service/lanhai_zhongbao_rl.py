...
class LanhaizhongbaorlMock(BusinessMock):

    def __init__(self, project, asset, asset_extend, asset_tran_list, period_start, period_end):
        self.channel = 'lanhai_zhongbao_rl'
        super(LanhaizhongbaorlMock, self).__init__(project, asset, asset_extend, asset_tran_list, period_start, period_end)
        self.trail_url = '/runlou/lanhai_zhongbao_rl/rl.assis.repayment.trial.apply'
        self.trail_query_url = ''
        self.repay_plan_url = ''
        self.repay_apply_url = ''
        self.repay_apply_query_url = '/runlou/lanhai_zhongbao_rl/rl.assis.repayment.query'
